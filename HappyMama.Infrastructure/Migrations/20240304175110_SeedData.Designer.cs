...
namespace HappyMama.Infrastructure.Migrations
{
    ...
    [Migration("20240304175110_SeedData")]
            ...
            modelBuilder.Entity("HappyMama.Infrastructure.Data.DataModels.Event", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatorId = "90402621-705a-4592-9195-70a26d1188cc",
                            DeadTime = new DateTime(2024, 3, 4, 17, 51, 10, 491, DateTimeKind.Utc).AddTicks(8616),
            ...
            modelBuilder.Entity("HappyMama.Infrastructure.Data.DataModels.News", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2024, 3, 4, 17, 51, 10, 491, DateTimeKind.Utc).AddTicks(8683),
                            CreatorId = "8b6afc3a-0922-497a-b97d-faf99cb5b2ff",
            ...
            modelBuilder.Entity("HappyMama.Infrastructure.Data.DataModels.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2024, 3, 4, 17, 51, 10, 491, DateTimeKind.Utc).AddTicks(8874),
                            CreatorId = "d2a09f19-256f-47ce-b661-04fe9fb105d6",
                            ThemeId = 1
                        },
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2024, 3, 4, 17, 51, 10, 491, DateTimeKind.Utc).AddTicks(8874),
                            CreatorId = "de119094-95c7-4b8f-a4be-e46203394b69",
                            ThemeId = 1
                        });
                });
            ...
            modelBuilder.Entity("HappyMama.Infrastructure.Data.DataModels.Theme", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2024, 3, 4, 17, 51, 10, 491, DateTimeKind.Utc).AddTicks(8786),
                            CreatorId = "d2a09f19-256f-47ce-b661-04fe9fb105d6",
